...
```bash
go get github.com/adyen/adyen-go-api-library/v15@v15.0.0
```
...
import (
	...
	"github.com/adyen/adyen-go-api-library/v15/src/adyen"
)
...
```go
import (
	"github.com/adyen/adyen-go-api-library/v15/src/webhook"
)

...
func (o *UpdatePaymentInstrument) GetReplacedById() string {
...
// and a boolean to check if the value has been set.
func (o *UpdatePaymentInstrument) GetReplacedByIdOk() (*string, bool) {
	if o == nil || common.IsNil(o.ReplacedById) {
		return nil, false
	}
...
func (o *UpdatePaymentInstrument) HasReplacedById() bool {
	if o != nil && !common.IsNil(o.ReplacedById) {
		return true
	}
...
func (o *UpdatePaymentInstrument) SetReplacedById(v string) {
	o.ReplacedById = &v
}

// GetReplacementOfId returns the ReplacementOfId field value if set, zero value otherwise.
func (o *UpdatePaymentInstrument) GetReplacementOfId() string {
...
// and a boolean to check if the value has been set.
func (o *UpdatePaymentInstrument) GetReplacementOfIdOk() (*string, bool) {
	if o == nil || common.IsNil(o.ReplacementOfId) {
		return nil, false
	}
...
func (o *UpdatePaymentInstrument) HasReplacementOfId() bool {
	if o != nil && !common.IsNil(o.ReplacementOfId) {
		return true
	}
...
func (o *UpdatePaymentInstrument) SetReplacementOfId(v string) {
	o.ReplacementOfId = &v
}

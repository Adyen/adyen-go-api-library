...
// checks if the MerchantsRestriction type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &MerchantsRestriction{}
...
type NullableMerchantsRestriction struct {
	value *MerchantsRestriction
	isSet bool
}

func (v NullableMerchantsRestriction) Get() *MerchantsRestriction {
	return v.value
}

func (v *NullableMerchantsRestriction) Set(val *MerchantsRestriction) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantsRestriction) IsSet() bool {
	return v.isSet
}
...
func NewNullableMerchantsRestriction(val *MerchantsRestriction) *NullableMerchantsRestriction {
	return &NullableMerchantsRestriction{value: val, isSet: true}
}

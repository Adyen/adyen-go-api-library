...
var _ common.MappedNullable = &PaymentInstrumentGroupInfo{}
...
func NewPaymentInstrumentGroupInfo(balancePlatform string, txVariant string) *PaymentInstrumentGroupInfo {
	this := PaymentInstrumentGroupInfo{}
...
type NullablePaymentInstrumentGroupInfo struct {
	value *PaymentInstrumentGroupInfo
	isSet bool
}

func (v NullablePaymentInstrumentGroupInfo) Get() *PaymentInstrumentGroupInfo {
	return v.value
}

func (v *NullablePaymentInstrumentGroupInfo) Set(val *PaymentInstrumentGroupInfo) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentInstrumentGroupInfo) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentInstrumentGroupInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentInstrumentGroupInfo(val *PaymentInstrumentGroupInfo) *NullablePaymentInstrumentGroupInfo {
	return &NullablePaymentInstrumentGroupInfo{value: val, isSet: true}
}

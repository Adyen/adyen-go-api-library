...
// checks if the ActiveNetworkTokensRestriction type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &ActiveNetworkTokensRestriction{}
...
func NewActiveNetworkTokensRestriction(operation string) *ActiveNetworkTokensRestriction {
	this := ActiveNetworkTokensRestriction{}
...
type NullableActiveNetworkTokensRestriction struct {
	value *ActiveNetworkTokensRestriction
	isSet bool
}

func (v NullableActiveNetworkTokensRestriction) Get() *ActiveNetworkTokensRestriction {
	return v.value
}

func (v *NullableActiveNetworkTokensRestriction) Set(val *ActiveNetworkTokensRestriction) {
	v.value = val
	v.isSet = true
}

func (v NullableActiveNetworkTokensRestriction) IsSet() bool {
	return v.isSet
}

func (v *NullableActiveNetworkTokensRestriction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActiveNetworkTokensRestriction(val *ActiveNetworkTokensRestriction) *NullableActiveNetworkTokensRestriction {
	return &NullableActiveNetworkTokensRestriction{value: val, isSet: true}
}

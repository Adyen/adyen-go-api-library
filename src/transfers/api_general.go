...
func (r GetTransactionsConfig) CreatedSince(createdSince time.Time) GetTransactionsConfig {
...
func (r GetTransactionsConfig) CreatedUntil(createdUntil time.Time) GetTransactionsConfig {
...
func (r GetTransactionsConfig) BalancePlatform(balancePlatform string) GetTransactionsConfig {
...
func (r GetTransactionsConfig) PaymentInstrumentId(paymentInstrumentId string) GetTransactionsConfig {
...
func (r GetTransactionsConfig) AccountHolderId(accountHolderId string) GetTransactionsConfig {
...
func (r GetTransactionsConfig) BalanceAccountId(balanceAccountId string) GetTransactionsConfig {
	r.balanceAccountId = &balanceAccountId
	return r
}

// The &#x60;cursor&#x60; returned in the links of the previous response.
func (r GetTransactionsConfig) Cursor(cursor string) GetTransactionsConfig {
	r.cursor = &cursor
	return r
}

// The number of items returned per page, maximum of 100 items. By default, the response returns 10 items per page.
func (r GetTransactionsConfig) Limit(limit int32) GetTransactionsConfig {
	r.limit = &limit
	return r
}
...
This endpoint supports cursor-based pagination. The response returns the first page of results, and returns links to the next page when applicable. You can use the links to page through the results. The response also returns links to the previous page when applicable.
 ...
 @return GetTransactionsConfig
*/
func (a *GeneralApi) GetTransactionsConfig(ctx context.Context) GetTransactionsConfig {
	return GetTransactionsConfig{
		ctx: ctx,
	}
}
...
func (a *GeneralApi) GetTransactions(r GetTransactionsConfig) (TransactionSearchResponse, *_nethttp.Response, error) {
...
Returns a transaction.
 ...
 @return GetTransactionsIdConfig
*/
func (a *GeneralApi) GetTransactionsIdConfig(ctx context.Context, id string) GetTransactionsIdConfig {
	return GetTransactionsIdConfig{
		ctx: ctx,
		id: id,
	}
...
func (a *GeneralApi) GetTransactionsId(r GetTransactionsIdConfig) (Transaction, *_nethttp.Response, error) {
    res := &Transaction{}
...
func (r PostTransfersConfig) TransferInfo(transferInfo TransferInfo) PostTransfersConfig {
...
To use this endpoint, you need an additional role for your API credential and transfers must be enabled for the source balance account. Your Adyen contact will set these up for you.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PostTransfersConfig
*/
func (a *GeneralApi) PostTransfersConfig(ctx context.Context) PostTransfersConfig {
	return PostTransfersConfig{
		ctx: ctx,
	}
}
...
func (a *GeneralApi) PostTransfers(r PostTransfersConfig) (Transfer, *_nethttp.Response, error) {
    res := &Transfer{}
	path := "/transfers"
    httpRes, err := a.Client.MakeHTTPPostRequest(r.transferInfo, res, a.BasePath() + path, r.ctx)
    return *res, httpRes, err
}

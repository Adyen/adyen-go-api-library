...
type TransferNotificationData struct {
	...
	RelayedAuthorisationData *RelayedAuthorisationData2 `json:"relayedAuthorisationData,omitempty"`
...
func (o *TransferNotificationData) GetRelayedAuthorisationData() RelayedAuthorisationData2 {
	if o == nil || common.IsNil(o.RelayedAuthorisationData) {
		var ret RelayedAuthorisationData2
		return ret
	}
...
// SetRelayedAuthorisationData gets a reference to the given RelayedAuthorisationData2 and assigns it to the RelayedAuthorisationData field.
...
func (o *TransferNotificationData) isValidPriority() bool {
	var allowedEnumValues = []string{"crossBorder", "directDebit", "fast", "instant", "regular", "wire"}
	for _, allowed := range allowedEnumValues {
...
func (o *TransferNotificationData) isValidReason() bool {
	var allowedEnumValues = []string{"amountLimitExceded", "approved", "counterpartyAccountBlocked", "counterpartyAccountClosed", "counterpartyAccountNotFound", "counterpartyAddressRequired", "counterpartyBankTimedOut", "counterpartyBankUnavailable", "error", "notEnoughBalance", "refusedByCounterpartyBank", "routeNotFound", "unknown"}
	for _, allowed := range allowedEnumValues {

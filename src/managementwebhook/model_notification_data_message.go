...
func NewNotificationDataMessage(createdAt time.Time, data AccountCreateNotificationData, environment string, type_ string) *NotificationDataMessage {
...
func (o *NotificationDataMessage) GetData() AccountCreateNotificationData {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *NotificationDataMessage) GetDataOk() (*AccountCreateNotificationData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *NotificationDataMessage) SetData(v AccountCreateNotificationData) {
	o.Data = v
}

...
func NewMidServiceNotificationData(id string, merchantId string, result string, type_ string) *MidServiceNotificationData {
...
func (o *MidServiceNotificationData) GetResult() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *MidServiceNotificationData) GetResultOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MidServiceNotificationData) SetResult(v string) {
	o.Result = v
}
...
func (o *MidServiceNotificationData) isValidResult() bool {
	var allowedEnumValues = []string{"SUCCESS", "FAILURE"}

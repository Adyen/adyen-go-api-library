...
import (
	...
	"github.com/adyen/adyen-go-api-library/v15/src/paymentsapp"

	"github.com/adyen/adyen-go-api-library/v15/src/dataprotection"

	"github.com/adyen/adyen-go-api-library/v15/src/balancecontrol"
	"github.com/adyen/adyen-go-api-library/v15/src/balanceplatform"
	"github.com/adyen/adyen-go-api-library/v15/src/binlookup"
	"github.com/adyen/adyen-go-api-library/v15/src/checkout"
	"github.com/adyen/adyen-go-api-library/v15/src/common"
	"github.com/adyen/adyen-go-api-library/v15/src/disputes"
	"github.com/adyen/adyen-go-api-library/v15/src/legalentity"
	"github.com/adyen/adyen-go-api-library/v15/src/management"
	"github.com/adyen/adyen-go-api-library/v15/src/payments"
	"github.com/adyen/adyen-go-api-library/v15/src/payout"
	"github.com/adyen/adyen-go-api-library/v15/src/platformsaccount"
	"github.com/adyen/adyen-go-api-library/v15/src/platformsfund"
	"github.com/adyen/adyen-go-api-library/v15/src/platformshostedonboardingpage"
	"github.com/adyen/adyen-go-api-library/v15/src/platformsnotificationconfiguration"
	"github.com/adyen/adyen-go-api-library/v15/src/posterminalmanagement"
	"github.com/adyen/adyen-go-api-library/v15/src/recurring"
	"github.com/adyen/adyen-go-api-library/v15/src/storedvalue"
	"github.com/adyen/adyen-go-api-library/v15/src/transfers"
)

...
/*
CheckAccountHolderPost Request to perform verification for an account holder.
...
/*
CloseAccountHolderPost Close an existing account holder.
...
/*
CloseAccountPost Close an existing account under an account holder.
...
/*
CreateAccountHolderPost Create a new account holder.
...
/*
CreateAccountPost Create a new account under an existing account holder.
...
/*
DeleteBankAccountsPost Delete bank accounts of an existing account holder.
...
/*
DeletePayoutMethodsPost Delete payout methods of an existing account holder.
...
/*
DeleteShareholdersPost Delete shareholders of an existing account holder.
...
/*
GetAccountHolderPost Retrieve the details of an account holder.
...
/*
GetUploadedDocumentsPost Retrieve the uploaded documents of an existing account holder.
This endpoint is used to retrieve documents previously uploaded for use in the KYC Verification of an account holder.  For further information regarding KYC Verification, please refer to [Verification checks](https://docs.adyen.com/marketpay/onboarding-and-verification/verification-checks).
...
/*
SuspendAccountHolderPost Suspend an existing account holder.
...
/*
UnSuspendAccountHolderPost Reinstate a disabled account holder.
...
/*
UpdateAccountHolderPost Update an existing account holder.
...
/*
UpdateAccountHolderStatePost Update the state of an existing account holder.
...
/*
UpdateAccountPost Update an existing account under an account holder.
...
/*
UploadDocumentPost Upload a document for an existing account holder.
This endpoint is used to upload a document for use in the KYC verification of an account holder.  For further information regarding KYC Verification, please refer to [Verification checks](https://docs.adyen.com/marketpay/onboarding-and-verification/verification-checks).

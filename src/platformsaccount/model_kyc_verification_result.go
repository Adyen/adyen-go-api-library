...
type KYCVerificationResult struct {
	AccountHolder KYCCheckResult `json:"accountHolder"`
	// The result(s) of the checks on the bank account(s).
	BankAccounts []KYCBankAccountCheckResult `json:"bankAccounts"`
	// The result(s) of the checks on the card(s).
	Cards []KYCCardCheckResult `json:"cards"`
	// The result(s) of the checks on the shareholder(s).
	Shareholders []KYCShareholderCheckResult `json:"shareholders"`
}

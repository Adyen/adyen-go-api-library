...
// checks if the StoredValueBalanceMergeResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &StoredValueBalanceMergeResponse{}
...
func NewStoredValueBalanceMergeResponse() *StoredValueBalanceMergeResponse {
	this := StoredValueBalanceMergeResponse{}
	return &this
}
...
type NullableStoredValueBalanceMergeResponse struct {
	value *StoredValueBalanceMergeResponse
	isSet bool
}

func (v NullableStoredValueBalanceMergeResponse) Get() *StoredValueBalanceMergeResponse {
	return v.value
}

func (v *NullableStoredValueBalanceMergeResponse) Set(val *StoredValueBalanceMergeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStoredValueBalanceMergeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStoredValueBalanceMergeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoredValueBalanceMergeResponse(val *StoredValueBalanceMergeResponse) *NullableStoredValueBalanceMergeResponse {
	return &NullableStoredValueBalanceMergeResponse{value: val, isSet: true}
}
...
func (o *StoredValueBalanceMergeResponse) isValidResultCode() bool {

...
// checks if the StoredValueIssueRequest type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &StoredValueIssueRequest{}
...
type NullableStoredValueIssueRequest struct {
	value *StoredValueIssueRequest
	isSet bool
}

func (v NullableStoredValueIssueRequest) Get() *StoredValueIssueRequest {
	return v.value
}

func (v *NullableStoredValueIssueRequest) Set(val *StoredValueIssueRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStoredValueIssueRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStoredValueIssueRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoredValueIssueRequest(val *StoredValueIssueRequest) *NullableStoredValueIssueRequest {
	return &NullableStoredValueIssueRequest{value: val, isSet: true}
}
...
func (o *StoredValueIssueRequest) isValidShopperInteraction() bool {

...
var _ common.MappedNullable = &StoredValueBalanceCheckRequest{}
...
func NewStoredValueBalanceCheckRequest(merchantAccount string, paymentMethod map[string]string, reference string) *StoredValueBalanceCheckRequest {
	this := StoredValueBalanceCheckRequest{}
...
type NullableStoredValueBalanceCheckRequest struct {
	value *StoredValueBalanceCheckRequest
	isSet bool
}

func (v NullableStoredValueBalanceCheckRequest) Get() *StoredValueBalanceCheckRequest {
	return v.value
}

func (v *NullableStoredValueBalanceCheckRequest) Set(val *StoredValueBalanceCheckRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStoredValueBalanceCheckRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStoredValueBalanceCheckRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoredValueBalanceCheckRequest(val *StoredValueBalanceCheckRequest) *NullableStoredValueBalanceCheckRequest {
	return &NullableStoredValueBalanceCheckRequest{value: val, isSet: true}
}

...
/*
PaymentLinks Retrieve a payment link.
...
*/
func (a Checkout) GetPaymentLinks(linkId string, ctxs ..._context.Context) (PaymentLinkResource, *_nethttp.Response, error) {
...
/*
UpdatePaymentLinks Update the status of a payment link
...
@return PaymentLinkResource
*/
func (a Checkout) UpdatePaymentLinks(linkId string, req *UpdatePaymentLinkRequest, ctxs ..._context.Context) (PaymentLinkResource, *_nethttp.Response, error) {
	res := &PaymentLinkResource{}

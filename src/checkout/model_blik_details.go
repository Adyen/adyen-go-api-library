...
var _ common.MappedNullable = &BlikDetails{}
...
func (o *BlikDetails) GetBlikCode() string {
	if o == nil || common.IsNil(o.BlikCode) {
		var ret string
		return ret
	}
	return *o.BlikCode
...
func (o *BlikDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *BlikDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *BlikDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *BlikDetails) SetSdkData(v string) {
	o.SdkData = &v
}

...
// All parameters accepted by PaymentsApi.UpdateSession
type PaymentsApiUpdateSessionInput struct {
	sessionId                          string
	checkoutSessionPatchSessionRequest *CheckoutSessionPatchSessionRequest
}

func (r PaymentsApiUpdateSessionInput) CheckoutSessionPatchSessionRequest(checkoutSessionPatchSessionRequest CheckoutSessionPatchSessionRequest) PaymentsApiUpdateSessionInput {
	r.checkoutSessionPatchSessionRequest = &checkoutSessionPatchSessionRequest
	return r
}

/*
Prepare a request for UpdateSession
@param sessionId
@return PaymentsApiUpdateSessionInput
*/
func (a *PaymentsApi) UpdateSessionInput(sessionId string) PaymentsApiUpdateSessionInput {
	return PaymentsApiUpdateSessionInput{
		sessionId: sessionId,
	}
}
...
/*
UpdateSession Update a payment session
...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param r PaymentsApiUpdateSessionInput - Request parameters, see UpdateSessionInput
@return CheckoutSessionPatchSessionResponse, *http.Response, error
*/
func (a *PaymentsApi) UpdateSession(ctx context.Context, r PaymentsApiUpdateSessionInput) (CheckoutSessionPatchSessionResponse, *http.Response, error) {
	res := &CheckoutSessionPatchSessionResponse{}
	path := "/sessions/{sessionId}"
	path = strings.Replace(path, "{"+"sessionId"+"}", url.PathEscape(common.ParameterValueToString(r.sessionId, "sessionId")), -1)
	queryParams := url.Values{}
	headerParams := make(map[string]string)
	httpRes, err := common.SendAPIRequest(
		ctx,
		a.Client,
		r.checkoutSessionPatchSessionRequest,
		res,
		http.MethodPatch,
		a.BasePath()+path,
		queryParams,

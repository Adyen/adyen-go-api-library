...
func (a *PaymentsApi) CardDetails(r PaymentsApiCardDetailsConfig) (CardDetailsResponse, *_nethttp.Response, error) {
	...
	path := "/cardDetails"
	httpRes, err := common.CreateHTTPRequest(a.Client, _nethttp.MethodPost, r.cardDetailsRequest, res, a.BasePath()+path, []_context.Context{r.ctx})
...
func (a *PaymentsApi) Donations(r PaymentsApiDonationsConfig) (DonationResponse, *_nethttp.Response, error) {
	...
	path := "/donations"
	httpRes, err := common.CreateHTTPRequest(a.Client, _nethttp.MethodPost, r.paymentDonationRequest, res, a.BasePath()+path, []_context.Context{r.ctx})
	return *res, httpRes, err
}
...
func (a *PaymentsApi) PaymentMethods(r PaymentsApiPaymentMethodsConfig) (PaymentMethodsResponse, *_nethttp.Response, error) {
	...
	path := "/paymentMethods"
	httpRes, err := common.CreateHTTPRequest(a.Client, _nethttp.MethodPost, r.paymentMethodsRequest, res, a.BasePath()+path, []_context.Context{r.ctx})
	return *res, httpRes, err
}
...
func (a *PaymentsApi) PaymentsDetails(r PaymentsApiPaymentsDetailsConfig) (PaymentDetailsResponse, *_nethttp.Response, error) {
	...
	httpRes, err := common.CreateHTTPRequest(a.Client, _nethttp.MethodPost, r.detailsRequest, res, a.BasePath()+path, []_context.Context{r.ctx})
	return *res, httpRes, err
}
...
func (a *PaymentsApi) Sessions(r PaymentsApiSessionsConfig) (CreateCheckoutSessionResponse, *_nethttp.Response, error) {
	...
	path := "/sessions"
	httpRes, err := common.CreateHTTPRequest(a.Client, _nethttp.MethodPost, r.createCheckoutSessionRequest, res, a.BasePath()+path, []_context.Context{r.ctx})
	return *res, httpRes, err
}

...
func (o *AfterpayDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *AfterpayDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *AfterpayDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *AfterpayDetails) SetSdkData(v string) {
	o.SdkData = &v
}

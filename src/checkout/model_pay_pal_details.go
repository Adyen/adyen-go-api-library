...
func (o *PayPalDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *PayPalDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *PayPalDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *PayPalDetails) SetSdkData(v string) {
	o.SdkData = &v
}

...
func (o *OpenInvoiceDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *OpenInvoiceDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *OpenInvoiceDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *OpenInvoiceDetails) SetSdkData(v string) {
	o.SdkData = &v
}

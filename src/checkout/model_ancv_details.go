...
func (o *AncvDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *AncvDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *AncvDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *AncvDetails) SetSdkData(v string) {
	o.SdkData = &v
}

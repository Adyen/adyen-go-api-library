...
func (o *RivertyDetails) GetMerchantData() string {
...
// and a boolean to check if the value has been set.
func (o *RivertyDetails) GetMerchantDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.MerchantData) {
		return nil, false
	}
...
func (o *RivertyDetails) HasMerchantData() bool {
	if o != nil && !common.IsNil(o.MerchantData) {
		return true
	}
...
// SetMerchantData gets a reference to the given string and assigns it to the MerchantData field.
func (o *RivertyDetails) SetMerchantData(v string) {
	o.MerchantData = &v
}
...
func (o *RivertyDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *RivertyDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *RivertyDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *RivertyDetails) SetSdkData(v string) {
	o.SdkData = &v
}

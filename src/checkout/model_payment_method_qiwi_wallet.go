...
type PaymentMethodQIWIWallet struct {
	// Must be set to **qiwiwallet**.
	Type string `json:"type"`
	// The shopper's telephone number prefix.
	QiwiwalletTelephoneNumberPrefix string `json:"qiwiwallet.telephoneNumberPrefix"`
	// The shopper's telephone number.
	QiwiwalletTelephoneNumber string `json:"qiwiwallet.telephoneNumber"`
}

...
func (o *IdealDonations) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *IdealDonations) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *IdealDonations) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *IdealDonations) SetSdkData(v string) {
	o.SdkData = &v
}

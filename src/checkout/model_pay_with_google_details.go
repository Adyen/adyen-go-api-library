...
func (o *PayWithGoogleDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *PayWithGoogleDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *PayWithGoogleDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *PayWithGoogleDetails) SetSdkData(v string) {
	o.SdkData = &v
}

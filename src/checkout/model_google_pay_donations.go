...
func (o *GooglePayDonations) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *GooglePayDonations) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *GooglePayDonations) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *GooglePayDonations) SetSdkData(v string) {
	o.SdkData = &v
}

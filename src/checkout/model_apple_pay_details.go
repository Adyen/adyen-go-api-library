...
func (o *ApplePayDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *ApplePayDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *ApplePayDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *ApplePayDetails) SetSdkData(v string) {
	o.SdkData = &v
}

...
func (o *KlarnaDetails) GetMerchantData() string {
...
// and a boolean to check if the value has been set.
func (o *KlarnaDetails) GetMerchantDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.MerchantData) {
		return nil, false
	}
...
func (o *KlarnaDetails) HasMerchantData() bool {
	if o != nil && !common.IsNil(o.MerchantData) {
		return true
	}
...
func (o *KlarnaDetails) SetMerchantData(v string) {
	o.MerchantData = &v
}

...
type PaymentAmountUpdateRequest struct {
	...
	AdjustAuthType *string `json:"adjustAuthType,omitempty"`
...
// GetAdjustAuthType returns the AdjustAuthType field value if set, zero value otherwise.
func (o *PaymentAmountUpdateRequest) GetAdjustAuthType() string {
	if o == nil || common.IsNil(o.AdjustAuthType) {
		var ret string
		return ret
	}
	return *o.AdjustAuthType
}

// GetAdjustAuthTypeOk returns a tuple with the AdjustAuthType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentAmountUpdateRequest) GetAdjustAuthTypeOk() (*string, bool) {
	if o == nil || common.IsNil(o.AdjustAuthType) {
		return nil, false
	}
	return o.AdjustAuthType, true
}

// HasAdjustAuthType returns a boolean if a field has been set.
func (o *PaymentAmountUpdateRequest) HasAdjustAuthType() bool {
	if o != nil && !common.IsNil(o.AdjustAuthType) {
		return true
	}
...
// SetAdjustAuthType gets a reference to the given string and assigns it to the AdjustAuthType field.
func (o *PaymentAmountUpdateRequest) SetAdjustAuthType(v string) {
	o.AdjustAuthType = &v
}

// GetAdjustAuthorisationData returns the AdjustAuthorisationData field value if set, zero value otherwise.
func (o *PaymentAmountUpdateRequest) GetAdjustAuthorisationData() string {
	if o == nil || common.IsNil(o.AdjustAuthorisationData) {
		var ret string
		return ret
	}
	return *o.AdjustAuthorisationData
}

// GetAdjustAuthorisationDataOk returns a tuple with the AdjustAuthorisationData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentAmountUpdateRequest) GetAdjustAuthorisationDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.AdjustAuthorisationData) {
		return nil, false
	}
	return o.AdjustAuthorisationData, true
}

// HasAdjustAuthorisationData returns a boolean if a field has been set.
func (o *PaymentAmountUpdateRequest) HasAdjustAuthorisationData() bool {
	if o != nil && !common.IsNil(o.AdjustAuthorisationData) {
		return true
	}
...
// SetAdjustAuthorisationData gets a reference to the given string and assigns it to the AdjustAuthorisationData field.
func (o *PaymentAmountUpdateRequest) SetAdjustAuthorisationData(v string) {
	o.AdjustAuthorisationData = &v
}
...
func (o *PaymentAmountUpdateRequest) GetMpiData() ThreeDSecureData {
...
// and a boolean to check if the value has been set.
func (o *PaymentAmountUpdateRequest) GetMpiDataOk() (*ThreeDSecureData, bool) {
	if o == nil || common.IsNil(o.MpiData) {
		return nil, false
	}
...
func (o *PaymentAmountUpdateRequest) HasMpiData() bool {
	if o != nil && !common.IsNil(o.MpiData) {
		return true
	}
...
func (o *PaymentAmountUpdateRequest) SetMpiData(v ThreeDSecureData) {
	o.MpiData = &v
}
...
func (o PaymentAmountUpdateRequest) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.AdjustAuthType) {
		toSerialize["adjustAuthType"] = o.AdjustAuthType
	}
	if !common.IsNil(o.AdjustAuthorisationData) {
		toSerialize["adjustAuthorisationData"] = o.AdjustAuthorisationData
	}
...
func (o *PaymentAmountUpdateRequest) isValidAdjustAuthType() bool {
	var allowedEnumValues = []string{"cardholderInitiatedTransaction", "merchantInitiatedTransaction"}
	for _, allowed := range allowedEnumValues {
		if o.GetAdjustAuthType() == allowed {
			return true
		}
	}
	return false

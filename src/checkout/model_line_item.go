...
type LineItem struct {
	...
	ReturnShippingCompany *string `json:"returnShippingCompany,omitempty"`
	...
	ReturnTrackingUri *string `json:"returnTrackingUri,omitempty"`
...
// GetReturnShippingCompany returns the ReturnShippingCompany field value if set, zero value otherwise.
func (o *LineItem) GetReturnShippingCompany() string {
	if o == nil || common.IsNil(o.ReturnShippingCompany) {
		var ret string
		return ret
	}
	return *o.ReturnShippingCompany
}

// GetReturnShippingCompanyOk returns a tuple with the ReturnShippingCompany field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LineItem) GetReturnShippingCompanyOk() (*string, bool) {
	if o == nil || common.IsNil(o.ReturnShippingCompany) {
		return nil, false
	}
	return o.ReturnShippingCompany, true
}

// HasReturnShippingCompany returns a boolean if a field has been set.
func (o *LineItem) HasReturnShippingCompany() bool {
	if o != nil && !common.IsNil(o.ReturnShippingCompany) {
		return true
	}
...
// SetReturnShippingCompany gets a reference to the given string and assigns it to the ReturnShippingCompany field.
func (o *LineItem) SetReturnShippingCompany(v string) {
	o.ReturnShippingCompany = &v
}

// GetReturnTrackingNumber returns the ReturnTrackingNumber field value if set, zero value otherwise.
func (o *LineItem) GetReturnTrackingNumber() string {
	if o == nil || common.IsNil(o.ReturnTrackingNumber) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LineItem) GetReturnTrackingNumberOk() (*string, bool) {
	if o == nil || common.IsNil(o.ReturnTrackingNumber) {
		return nil, false
	}
...
func (o *LineItem) HasReturnTrackingNumber() bool {
	if o != nil && !common.IsNil(o.ReturnTrackingNumber) {
		return true
	}
...
func (o *LineItem) SetReturnTrackingNumber(v string) {
	o.ReturnTrackingNumber = &v
}

// GetReturnTrackingUri returns the ReturnTrackingUri field value if set, zero value otherwise.
func (o *LineItem) GetReturnTrackingUri() string {
	if o == nil || common.IsNil(o.ReturnTrackingUri) {
		var ret string
		return ret
	}
	return *o.ReturnTrackingUri
}

// GetReturnTrackingUriOk returns a tuple with the ReturnTrackingUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LineItem) GetReturnTrackingUriOk() (*string, bool) {
	if o == nil || common.IsNil(o.ReturnTrackingUri) {
		return nil, false
	}
	return o.ReturnTrackingUri, true
}

// HasReturnTrackingUri returns a boolean if a field has been set.
func (o *LineItem) HasReturnTrackingUri() bool {
	if o != nil && !common.IsNil(o.ReturnTrackingUri) {
		return true
	}
...
// SetReturnTrackingUri gets a reference to the given string and assigns it to the ReturnTrackingUri field.
func (o *LineItem) SetReturnTrackingUri(v string) {
	o.ReturnTrackingUri = &v
}

// GetShippingCompany returns the ShippingCompany field value if set, zero value otherwise.
func (o *LineItem) GetShippingCompany() string {
	if o == nil || common.IsNil(o.ShippingCompany) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LineItem) GetShippingCompanyOk() (*string, bool) {
	if o == nil || common.IsNil(o.ShippingCompany) {
		return nil, false
	}
...
func (o *LineItem) HasShippingCompany() bool {
	if o != nil && !common.IsNil(o.ShippingCompany) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *LineItem) GetShippingMethodOk() (*string, bool) {
	if o == nil || common.IsNil(o.ShippingMethod) {
		return nil, false
	}
...
func (o *LineItem) HasShippingMethod() bool {
	if o != nil && !common.IsNil(o.ShippingMethod) {
		return true
	}
...
func (o *LineItem) SetShippingMethod(v string) {
	o.ShippingMethod = &v
}
...
func (o *LineItem) GetTrackingNumber() string {
...
// and a boolean to check if the value has been set.
func (o *LineItem) GetTrackingNumberOk() (*string, bool) {
	if o == nil || common.IsNil(o.TrackingNumber) {
		return nil, false
	}
...
func (o *LineItem) HasTrackingNumber() bool {
	if o != nil && !common.IsNil(o.TrackingNumber) {
		return true
	}
...
func (o *LineItem) SetTrackingNumber(v string) {
	o.TrackingNumber = &v
}

// GetTrackingUri returns the TrackingUri field value if set, zero value otherwise.
func (o *LineItem) GetTrackingUri() string {
	if o == nil || common.IsNil(o.TrackingUri) {
		var ret string
		return ret
	}
	return *o.TrackingUri
}

// GetTrackingUriOk returns a tuple with the TrackingUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LineItem) GetTrackingUriOk() (*string, bool) {
	if o == nil || common.IsNil(o.TrackingUri) {
		return nil, false
	}
	return o.TrackingUri, true
}

// HasTrackingUri returns a boolean if a field has been set.
func (o *LineItem) HasTrackingUri() bool {
	if o != nil && !common.IsNil(o.TrackingUri) {
		return true
	}
...
// SetTrackingUri gets a reference to the given string and assigns it to the TrackingUri field.
func (o *LineItem) SetTrackingUri(v string) {
	o.TrackingUri = &v
}
...
func (o LineItem) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.ReturnShippingCompany) {
		toSerialize["returnShippingCompany"] = o.ReturnShippingCompany
	}
	if !common.IsNil(o.ReturnTrackingNumber) {
		toSerialize["returnTrackingNumber"] = o.ReturnTrackingNumber
	}
	if !common.IsNil(o.ReturnTrackingUri) {
		toSerialize["returnTrackingUri"] = o.ReturnTrackingUri
	}
	if !common.IsNil(o.ShippingCompany) {
	...
	if !common.IsNil(o.TrackingUri) {
		toSerialize["trackingUri"] = o.TrackingUri
	}

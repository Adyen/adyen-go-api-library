...
func (o *PaymentAmountUpdateResponse) GetAdjustAuthorisationData() string {
...
func (o *PaymentAmountUpdateResponse) GetAdjustAuthorisationDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.AdjustAuthorisationData) {
		return nil, false
	}
...
func (o *PaymentAmountUpdateResponse) HasAdjustAuthorisationData() bool {
	if o != nil && !common.IsNil(o.AdjustAuthorisationData) {
		return true
	}
...
func (o *PaymentAmountUpdateResponse) SetAdjustAuthorisationData(v string) {
...
func (o *PaymentAmountUpdateResponse) isValidStatus() bool {
	var allowedEnumValues = []string{"authorised", "received", "refused"}
	for _, allowed := range allowedEnumValues {

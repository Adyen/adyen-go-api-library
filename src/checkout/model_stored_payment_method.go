...
func (o *StoredPaymentMethod) GetCashtag() string {
...
// and a boolean to check if the value has been set.
func (o *StoredPaymentMethod) GetCashtagOk() (*string, bool) {
	if o == nil || common.IsNil(o.Cashtag) {
		return nil, false
	}
...
func (o *StoredPaymentMethod) HasCashtag() bool {
	if o != nil && !common.IsNil(o.Cashtag) {
		return true
	}
...
func (o *StoredPaymentMethod) SetCashtag(v string) {
	o.Cashtag = &v
}
...
func (o *StoredPaymentMethod) GetExternalToken() string {
	if o == nil || common.IsNil(o.ExternalToken) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StoredPaymentMethod) GetExternalTokenOk() (*string, bool) {
	if o == nil || common.IsNil(o.ExternalToken) {
		return nil, false
	}
...
func (o *StoredPaymentMethod) HasExternalToken() bool {
	if o != nil && !common.IsNil(o.ExternalToken) {
		return true
	}
...
func (o *StoredPaymentMethod) SetExternalToken(v string) {
	o.ExternalToken = &v
}
...
func (o StoredPaymentMethod) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.ExternalToken) {

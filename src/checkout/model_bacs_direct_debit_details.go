...
func (o *BacsDirectDebitDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *BacsDirectDebitDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *BacsDirectDebitDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *BacsDirectDebitDetails) SetSdkData(v string) {
	o.SdkData = &v
}

...
func (o *RatepayDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *RatepayDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *RatepayDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *RatepayDetails) SetSdkData(v string) {
	o.SdkData = &v
}

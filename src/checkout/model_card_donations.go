...
func (o *CardDonations) GetSrcDigitalCardId() string {
...
// and a boolean to check if the value has been set.
func (o *CardDonations) GetSrcDigitalCardIdOk() (*string, bool) {
	if o == nil || common.IsNil(o.SrcDigitalCardId) {
		return nil, false
	}
...
func (o *CardDonations) HasSrcDigitalCardId() bool {
	if o != nil && !common.IsNil(o.SrcDigitalCardId) {
		return true
	}
...
func (o *CardDonations) SetSrcDigitalCardId(v string) {

...
type CreateCheckoutSessionRequest struct {
	...
	ThirdPartyTokenRedundancyInfo *ThirdPartyTokenRedundancyInfo      `json:"thirdPartyTokenRedundancyInfo,omitempty"`
...
func (o *CreateCheckoutSessionRequest) GetShopperConversionId() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCheckoutSessionRequest) GetShopperConversionIdOk() (*string, bool) {
	if o == nil || common.IsNil(o.ShopperConversionId) {
		return nil, false
	}
...
func (o *CreateCheckoutSessionRequest) HasShopperConversionId() bool {
	if o != nil && !common.IsNil(o.ShopperConversionId) {
		return true
	}
...
func (o *CreateCheckoutSessionRequest) SetShopperConversionId(v string) {
...
func (o *CreateCheckoutSessionRequest) GetShopperName() ShopperName {
...
// and a boolean to check if the value has been set.
func (o *CreateCheckoutSessionRequest) GetShopperNameOk() (*ShopperName, bool) {
	if o == nil || common.IsNil(o.ShopperName) {
		return nil, false
	}
...
func (o *CreateCheckoutSessionRequest) SetShopperName(v ShopperName) {
	o.ShopperName = &v
}
...
func (o *CreateCheckoutSessionRequest) GetShowRemovePaymentMethodButton() bool {
...
// and a boolean to check if the value has been set.
func (o *CreateCheckoutSessionRequest) GetShowRemovePaymentMethodButtonOk() (*bool, bool) {
	if o == nil || common.IsNil(o.ShowRemovePaymentMethodButton) {
		return nil, false
	}
...
func (o *CreateCheckoutSessionRequest) HasShowRemovePaymentMethodButton() bool {
	if o != nil && !common.IsNil(o.ShowRemovePaymentMethodButton) {
		return true
	}
...
func (o *CreateCheckoutSessionRequest) SetShowRemovePaymentMethodButton(v bool) {
...
func (o *CreateCheckoutSessionRequest) GetStoreFiltrationMode() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCheckoutSessionRequest) GetStoreFiltrationModeOk() (*string, bool) {
	if o == nil || common.IsNil(o.StoreFiltrationMode) {
		return nil, false
	}
...
func (o *CreateCheckoutSessionRequest) HasStoreFiltrationMode() bool {
	if o != nil && !common.IsNil(o.StoreFiltrationMode) {
		return true
	}
...
func (o *CreateCheckoutSessionRequest) SetStoreFiltrationMode(v string) {
...
// GetThirdPartyTokenRedundancyInfo returns the ThirdPartyTokenRedundancyInfo field value if set, zero value otherwise.
func (o *CreateCheckoutSessionRequest) GetThirdPartyTokenRedundancyInfo() ThirdPartyTokenRedundancyInfo {
	if o == nil || common.IsNil(o.ThirdPartyTokenRedundancyInfo) {
		var ret ThirdPartyTokenRedundancyInfo
		return ret
	}
	return *o.ThirdPartyTokenRedundancyInfo
}

// GetThirdPartyTokenRedundancyInfoOk returns a tuple with the ThirdPartyTokenRedundancyInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCheckoutSessionRequest) GetThirdPartyTokenRedundancyInfoOk() (*ThirdPartyTokenRedundancyInfo, bool) {
	if o == nil || common.IsNil(o.ThirdPartyTokenRedundancyInfo) {
		return nil, false
	}
	return o.ThirdPartyTokenRedundancyInfo, true
}

// HasThirdPartyTokenRedundancyInfo returns a boolean if a field has been set.
func (o *CreateCheckoutSessionRequest) HasThirdPartyTokenRedundancyInfo() bool {
	if o != nil && !common.IsNil(o.ThirdPartyTokenRedundancyInfo) {
		return true
	}
...
// SetThirdPartyTokenRedundancyInfo gets a reference to the given ThirdPartyTokenRedundancyInfo and assigns it to the ThirdPartyTokenRedundancyInfo field.
func (o *CreateCheckoutSessionRequest) SetThirdPartyTokenRedundancyInfo(v ThirdPartyTokenRedundancyInfo) {
	o.ThirdPartyTokenRedundancyInfo = &v
}

// GetThreeDS2RequestData returns the ThreeDS2RequestData field value if set, zero value otherwise.
func (o *CreateCheckoutSessionRequest) GetThreeDS2RequestData() CheckoutSessionThreeDS2RequestData {
...
// and a boolean to check if the value has been set.
func (o *CreateCheckoutSessionRequest) GetThreeDS2RequestDataOk() (*CheckoutSessionThreeDS2RequestData, bool) {
	if o == nil || common.IsNil(o.ThreeDS2RequestData) {
		return nil, false
	}
...
func (o *CreateCheckoutSessionRequest) HasThreeDS2RequestData() bool {
	if o != nil && !common.IsNil(o.ThreeDS2RequestData) {
		return true
	}
...
func (o *CreateCheckoutSessionRequest) SetThreeDS2RequestData(v CheckoutSessionThreeDS2RequestData) {
...
func (o CreateCheckoutSessionRequest) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.ThirdPartyTokenRedundancyInfo) {
		toSerialize["thirdPartyTokenRedundancyInfo"] = o.ThirdPartyTokenRedundancyInfo
	}
...
func (o *CreateCheckoutSessionRequest) isValidStoreFiltrationMode() bool {

...
func (o *GooglePayDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *GooglePayDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *GooglePayDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *GooglePayDetails) SetSdkData(v string) {
	o.SdkData = &v
}

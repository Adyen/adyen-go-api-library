...
func (o *CardBrandDetails) GetHealthcare() bool {
...
func (o *CardBrandDetails) GetHealthcareOk() (*bool, bool) {
	if o == nil || common.IsNil(o.Healthcare) {
		return nil, false
	}
...
func (o *CardBrandDetails) HasHealthcare() bool {
	if o != nil && !common.IsNil(o.Healthcare) {
		return true
	}
...
// SetHealthcare gets a reference to the given bool and assigns it to the Healthcare field.
func (o *CardBrandDetails) SetHealthcare(v bool) {
	o.Healthcare = &v
}

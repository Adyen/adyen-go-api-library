...
func NewDonation(currency string, type_ string) *Donation {
	this := Donation{}
...
// GetDonationType returns the DonationType field value if set, zero value otherwise.
// Deprecated since Adyen Checkout API v72
/* Use `type` instead. */
func (o *Donation) GetDonationType() string {
	if o == nil || common.IsNil(o.DonationType) {
		var ret string
		return ret
	}
...
// GetDonationTypeOk returns a tuple with the DonationType field value if set, nil otherwise
// and a boolean to check if the value has been set.
// Deprecated since Adyen Checkout API v72
/* Use `type` instead. */
...
// HasDonationType returns a boolean if a field has been set.
func (o *Donation) HasDonationType() bool {
	if o != nil && !common.IsNil(o.DonationType) {
		return true
	}
...
// SetDonationType gets a reference to the given string and assigns it to the DonationType field.
// Deprecated since Adyen Checkout API v72
/* Use `type` instead. */
...
func (o Donation) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.DonationType) {

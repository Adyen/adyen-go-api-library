...
func (o *IdealDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *IdealDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *IdealDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *IdealDetails) SetSdkData(v string) {
	o.SdkData = &v
}

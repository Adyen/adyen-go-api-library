...
func (o *TwintDetails) GetSdkData() string {
...
// and a boolean to check if the value has been set.
func (o *TwintDetails) GetSdkDataOk() (*string, bool) {
	if o == nil || common.IsNil(o.SdkData) {
		return nil, false
	}
...
func (o *TwintDetails) HasSdkData() bool {
	if o != nil && !common.IsNil(o.SdkData) {
		return true
	}
...
func (o *TwintDetails) SetSdkData(v string) {
	o.SdkData = &v
}

...
// NewBeneficiarySetupNotification instantiates a new BeneficiarySetupNotification object
...
// NewBeneficiarySetupNotificationWithDefaults instantiates a new BeneficiarySetupNotification object
...
func (o *BeneficiarySetupNotification) SetContent(v BeneficiarySetupNotificationContent) {
	o.Content = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *BeneficiarySetupNotification) GetError() NotificationErrorContainer {
...
// and a boolean to check if the value has been set.
func (o *BeneficiarySetupNotification) GetErrorOk() (*NotificationErrorContainer, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
func (o *BeneficiarySetupNotification) SetError(v NotificationErrorContainer) {
	o.Error = &v
}
...
type NullableBeneficiarySetupNotification struct {
	value *BeneficiarySetupNotification
	isSet bool
}

func (v NullableBeneficiarySetupNotification) Get() *BeneficiarySetupNotification {
	return v.value
}

func (v *NullableBeneficiarySetupNotification) Set(val *BeneficiarySetupNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableBeneficiarySetupNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableBeneficiarySetupNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBeneficiarySetupNotification(val *BeneficiarySetupNotification) *NullableBeneficiarySetupNotification {
	return &NullableBeneficiarySetupNotification{value: val, isSet: true}
}

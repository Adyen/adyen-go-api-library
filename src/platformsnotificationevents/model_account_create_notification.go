...
// NewAccountCreateNotification instantiates a new AccountCreateNotification object
...
// NewAccountCreateNotificationWithDefaults instantiates a new AccountCreateNotification object
...
func (o *AccountCreateNotification) SetContent(v CreateAccountResponse) {
	o.Content = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *AccountCreateNotification) GetError() NotificationErrorContainer {
...
// and a boolean to check if the value has been set.
func (o *AccountCreateNotification) GetErrorOk() (*NotificationErrorContainer, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
func (o *AccountCreateNotification) SetError(v NotificationErrorContainer) {
	o.Error = &v
}
...
type NullableAccountCreateNotification struct {
	value *AccountCreateNotification
	isSet bool
}

func (v NullableAccountCreateNotification) Get() *AccountCreateNotification {
	return v.value
}

func (v *NullableAccountCreateNotification) Set(val *AccountCreateNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountCreateNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountCreateNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountCreateNotification(val *AccountCreateNotification) *NullableAccountCreateNotification {
	return &NullableAccountCreateNotification{value: val, isSet: true}
}

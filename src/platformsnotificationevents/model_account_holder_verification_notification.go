...
// NewAccountHolderVerificationNotification instantiates a new AccountHolderVerificationNotification object
...
func NewAccountHolderVerificationNotification(content AccountHolderVerificationNotificationContent, eventDate time.Time, eventType string, executingUserKey string, live bool, pspReference string) *AccountHolderVerificationNotification {
	this := AccountHolderVerificationNotification{}
...
// NewAccountHolderVerificationNotificationWithDefaults instantiates a new AccountHolderVerificationNotification object
...
func (o *AccountHolderVerificationNotification) GetContent() AccountHolderVerificationNotificationContent {
	if o == nil {
		var ret AccountHolderVerificationNotificationContent
		return ret
	}
...
func (o *AccountHolderVerificationNotification) GetContentOk() (*AccountHolderVerificationNotificationContent, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AccountHolderVerificationNotification) SetContent(v AccountHolderVerificationNotificationContent) {
	o.Content = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *AccountHolderVerificationNotification) GetError() NotificationErrorContainer {
...
// and a boolean to check if the value has been set.
func (o *AccountHolderVerificationNotification) GetErrorOk() (*NotificationErrorContainer, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
func (o *AccountHolderVerificationNotification) HasError() bool {
	if o != nil && o.Error != nil {
		return true
	}
...
func (o *AccountHolderVerificationNotification) SetError(v NotificationErrorContainer) {
	o.Error = &v
}

// GetEventDate returns the EventDate field value
func (o *AccountHolderVerificationNotification) GetEventDate() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *AccountHolderVerificationNotification) GetEventType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AccountHolderVerificationNotification) GetLive() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *AccountHolderVerificationNotification) SetLive(v bool) {
	o.Live = v
}
...
type NullableAccountHolderVerificationNotification struct {
	value *AccountHolderVerificationNotification
	isSet bool
}

func (v NullableAccountHolderVerificationNotification) Get() *AccountHolderVerificationNotification {
	return v.value
}

func (v *NullableAccountHolderVerificationNotification) Set(val *AccountHolderVerificationNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountHolderVerificationNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountHolderVerificationNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountHolderVerificationNotification(val *AccountHolderVerificationNotification) *NullableAccountHolderVerificationNotification {
	return &NullableAccountHolderVerificationNotification{value: val, isSet: true}
}

func (v NullableAccountHolderVerificationNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountHolderVerificationNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true

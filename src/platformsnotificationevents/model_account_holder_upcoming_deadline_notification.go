...
// NewAccountHolderUpcomingDeadlineNotification instantiates a new AccountHolderUpcomingDeadlineNotification object
...
// NewAccountHolderUpcomingDeadlineNotificationWithDefaults instantiates a new AccountHolderUpcomingDeadlineNotification object
...
func (o *AccountHolderUpcomingDeadlineNotification) GetContent() AccountHolderUpcomingDeadlineNotificationContent {
	if o == nil || o.Content == nil {
		var ret AccountHolderUpcomingDeadlineNotificationContent
		return ret
	}
	return *o.Content
}
...
func (o *AccountHolderUpcomingDeadlineNotification) GetContentOk() (*AccountHolderUpcomingDeadlineNotificationContent, bool) {
	if o == nil || o.Content == nil {
		return nil, false
	}
...
func (o *AccountHolderUpcomingDeadlineNotification) HasContent() bool {
	if o != nil && o.Content != nil {
		return true
	}
...
func (o *AccountHolderUpcomingDeadlineNotification) SetContent(v AccountHolderUpcomingDeadlineNotificationContent) {
	o.Content = &v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *AccountHolderUpcomingDeadlineNotification) GetError() NotificationErrorContainer {
...
// and a boolean to check if the value has been set.
func (o *AccountHolderUpcomingDeadlineNotification) GetErrorOk() (*NotificationErrorContainer, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
func (o *AccountHolderUpcomingDeadlineNotification) HasError() bool {
	if o != nil && o.Error != nil {
		return true
	}
...
func (o *AccountHolderUpcomingDeadlineNotification) SetError(v NotificationErrorContainer) {
	o.Error = &v
}
...
func (o *AccountHolderUpcomingDeadlineNotification) SetEventDate(v time.Time) {
	o.EventDate = v
}
...
func (o *AccountHolderUpcomingDeadlineNotification) SetEventType(v string) {
	o.EventType = v
}
...
func (o *AccountHolderUpcomingDeadlineNotification) SetLive(v bool) {
	o.Live = v
}
...
func (o AccountHolderUpcomingDeadlineNotification) MarshalJSON() ([]byte, error) {
...
type NullableAccountHolderUpcomingDeadlineNotification struct {
	value *AccountHolderUpcomingDeadlineNotification
	isSet bool
}

func (v NullableAccountHolderUpcomingDeadlineNotification) Get() *AccountHolderUpcomingDeadlineNotification {
	return v.value
}

func (v *NullableAccountHolderUpcomingDeadlineNotification) Set(val *AccountHolderUpcomingDeadlineNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountHolderUpcomingDeadlineNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountHolderUpcomingDeadlineNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountHolderUpcomingDeadlineNotification(val *AccountHolderUpcomingDeadlineNotification) *NullableAccountHolderUpcomingDeadlineNotification {
	return &NullableAccountHolderUpcomingDeadlineNotification{value: val, isSet: true}
}

func (v NullableAccountHolderUpcomingDeadlineNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountHolderUpcomingDeadlineNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true

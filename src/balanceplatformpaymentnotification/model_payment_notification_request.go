...
type PaymentNotificationRequest struct {
	Data PaymentNotificationData `json:"data"`
...
func (o *PaymentNotificationRequest) GetData() PaymentNotificationData {
	if o == nil {
		var ret PaymentNotificationData
		return ret
	}
...
func (o *PaymentNotificationRequest) isValidType() bool {
	var allowedEnumValues = []string{"balancePlatform.payment.created", "balancePlatform.payment.updated"}

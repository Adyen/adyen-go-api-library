...
func (o *Opi) GetEnablePayAtTable() bool {
	if o == nil || isNil(o.EnablePayAtTable) {
		var ret bool
		return ret
	}
...
func (o *Opi) GetPayAtTableStoreNumber() string {
	if o == nil || isNil(o.PayAtTableStoreNumber) {
		var ret string
		return ret
	}
...
func (o *Opi) GetPayAtTableURL() string {
	if o == nil || isNil(o.PayAtTableURL) {
		var ret string
		return ret
	}

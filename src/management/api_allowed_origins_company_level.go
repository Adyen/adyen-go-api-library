...
func (a *AllowedOriginsCompanyLevelApi) CreateAllowedOrigin(r AllowedOriginsCompanyLevelApiCreateAllowedOriginConfig) (AllowedOriginsResponse, *_nethttp.Response, RestServiceError) {
...
func (a *AllowedOriginsCompanyLevelApi) DeleteAllowedOrigin(r AllowedOriginsCompanyLevelApiDeleteAllowedOriginConfig) (*_nethttp.Response, RestServiceError) {
	var v RestServiceError
	var res interface{}
...
func (a *AllowedOriginsCompanyLevelApi) GetAllowedOrigin(r AllowedOriginsCompanyLevelApiGetAllowedOriginConfig) (AllowedOrigin, *_nethttp.Response, RestServiceError) {
	var v RestServiceError
	res := &AllowedOrigin{}
	path := "/companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins/{originId}"
	path = strings.Replace(path, "{"+"companyId"+"}", url.PathEscape(common.ParameterValueToString(r.companyId, "companyId")), -1)
...
func (a *AllowedOriginsCompanyLevelApi) ListAllowedOrigins(r AllowedOriginsCompanyLevelApiListAllowedOriginsConfig) (AllowedOriginsResponse, *_nethttp.Response, RestServiceError) {
	var v RestServiceError
	res := &AllowedOriginsResponse{}
	path := "/companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins"
	path = strings.Replace(path, "{"+"companyId"+"}", url.PathEscape(common.ParameterValueToString(r.companyId, "companyId")), -1)

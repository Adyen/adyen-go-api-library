...
func (o *Webhook) GetAccountReference() string {
	if o == nil || isNil(o.AccountReference) {
		var ret string
		return ret
	}
...
func (o *Webhook) GetFilterMerchantAccountType() string {
	if o == nil || isNil(o.FilterMerchantAccountType) {
		var ret string
		return ret
	}
...
func (o *Webhook) GetFilterMerchantAccounts() []string {
	if o == nil || isNil(o.FilterMerchantAccounts) {
		var ret []string
		return ret
	}
...
func (o *Webhook) GetHmacKeyCheckValue() string {
	if o == nil || isNil(o.HmacKeyCheckValue) {
		var ret string
		return ret
	}
...
func (o Webhook) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.FilterMerchantAccountType) {
		toSerialize["filterMerchantAccountType"] = o.FilterMerchantAccountType
	}
	if !isNil(o.FilterMerchantAccounts) {

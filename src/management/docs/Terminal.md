...
**CompanyAccount** | Pointer to **string** | The company account that the terminal is associated with. If this is the only account level shown in the response, the terminal is assigned to the inventory of the company account. | [optional] 
**CountryCode** | Pointer to **string** | The country code of the country where the terminal is located. | [optional] 
...
**StoreStatus** | Pointer to **string** | The status of the store that the terminal is assigned to. | [optional] 
...
**WifiSsid** | Pointer to **string** | The SSID of the Wi-Fi network that your terminal is connected to. | [optional] 

...
**Items** | Pointer to [**[]TerminalActionScheduleDetail**](TerminalActionScheduleDetail.md) | A list containing a terminal ID and an action ID for each terminal that the action was scheduled for. | [optional] 
...
**TerminalIds** | Pointer to **[]string** | A list of unique IDs of the terminals that the action applies to. | [optional] 

...
func (o *MeApiCredential) GetSubjectDN() string {
...
// and a boolean to check if the value has been set.
func (o *MeApiCredential) GetSubjectDNOk() (*string, bool) {
	if o == nil || common.IsNil(o.SubjectDN) {
		return nil, false
	}
...
func (o *MeApiCredential) HasSubjectDN() bool {
	if o != nil && !common.IsNil(o.SubjectDN) {
		return true
	}
...
func (o *MeApiCredential) SetSubjectDN(v string) {
	o.SubjectDN = &v
}

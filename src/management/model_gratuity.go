...
func (o *Gratuity) GetAllowCustomAmount() bool {
	if o == nil || isNil(o.AllowCustomAmount) {
		var ret bool
		return ret
	}
...
func (o *Gratuity) GetPredefinedTipEntries() []string {
	if o == nil || isNil(o.PredefinedTipEntries) {
		var ret []string
		return ret
	}
...
func (o *Gratuity) GetUsePredefinedTipEntries() bool {
	if o == nil || isNil(o.UsePredefinedTipEntries) {
		var ret bool
		return ret
	}

...
func (o *Profile) GetEapClientCert() File {
	if o == nil || isNil(o.EapClientCert) {
		var ret File
		return ret
	}
...
func (o *Profile) GetEapIntermediateCert() File {
	if o == nil || isNil(o.EapIntermediateCert) {
		var ret File
		return ret
	}

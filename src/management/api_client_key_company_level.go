...
func (a *ClientKeyCompanyLevelApi) GenerateNewClientKey(r ClientKeyCompanyLevelApiGenerateNewClientKeyConfig) (GenerateClientKeyResponse, *_nethttp.Response, RestServiceError) {

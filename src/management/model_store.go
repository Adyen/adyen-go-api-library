...
func (o *Store) GetLocalizedInformation() LocalizedInformation {
...
// and a boolean to check if the value has been set.
func (o *Store) GetLocalizedInformationOk() (*LocalizedInformation, bool) {
	if o == nil || common.IsNil(o.LocalizedInformation) {
		return nil, false
	}
...
func (o *Store) HasLocalizedInformation() bool {
	if o != nil && !common.IsNil(o.LocalizedInformation) {
		return true
	}
...
func (o *Store) SetLocalizedInformation(v LocalizedInformation) {

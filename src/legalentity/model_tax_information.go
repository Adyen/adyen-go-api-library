...
// GetNumberAbsent returns the NumberAbsent field value if set, zero value otherwise.
func (o *TaxInformation) GetNumberAbsent() bool {
	if o == nil || common.IsNil(o.NumberAbsent) {
		var ret bool
		return ret
	}
	return *o.NumberAbsent
}

// GetNumberAbsentOk returns a tuple with the NumberAbsent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TaxInformation) GetNumberAbsentOk() (*bool, bool) {
	if o == nil || common.IsNil(o.NumberAbsent) {
		return nil, false
	}
	return o.NumberAbsent, true
}

// HasNumberAbsent returns a boolean if a field has been set.
func (o *TaxInformation) HasNumberAbsent() bool {
	if o != nil && !common.IsNil(o.NumberAbsent) {
		return true
	}
...
// SetNumberAbsent gets a reference to the given bool and assigns it to the NumberAbsent field.
func (o *TaxInformation) SetNumberAbsent(v bool) {
	o.NumberAbsent = &v
}
...
func (o TaxInformation) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.NumberAbsent) {
		toSerialize["numberAbsent"] = o.NumberAbsent
	}

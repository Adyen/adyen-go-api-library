...
// APIClient manages communication with the Legal Entity Management API API v2
...
type APIClient struct {
	...
	BusinessLinesApi *BusinessLinesApiService

	DocumentsApi *DocumentsApiService

	HostedOnboardingApi *HostedOnboardingApiService

	LegalEntitiesApi *LegalEntitiesApiService

	TermsOfServiceApi *TermsOfServiceApiService

	TransferInstrumentsApi *TransferInstrumentsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BusinessLinesApi = (*BusinessLinesApiService)(&c.common)
	c.DocumentsApi = (*DocumentsApiService)(&c.common)
	c.HostedOnboardingApi = (*HostedOnboardingApiService)(&c.common)
	c.LegalEntitiesApi = (*LegalEntitiesApiService)(&c.common)
	c.TermsOfServiceApi = (*TermsOfServiceApiService)(&c.common)
	c.TransferInstrumentsApi = (*TransferInstrumentsApiService)(&c.common)

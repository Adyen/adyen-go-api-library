...
func (o *BusinessLineInfo) GetIndustryCodeDescription() string {
...
// and a boolean to check if the value has been set.
func (o *BusinessLineInfo) GetIndustryCodeDescriptionOk() (*string, bool) {
	if o == nil || common.IsNil(o.IndustryCodeDescription) {
		return nil, false
	}
...
func (o *BusinessLineInfo) HasIndustryCodeDescription() bool {
	if o != nil && !common.IsNil(o.IndustryCodeDescription) {
		return true
	}
...
func (o *BusinessLineInfo) SetIndustryCodeDescription(v string) {

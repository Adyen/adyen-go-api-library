...
// GetDateOfInitiationOfLegalProceeding returns the DateOfInitiationOfLegalProceeding field value if set, zero value otherwise.
func (o *Organization) GetDateOfInitiationOfLegalProceeding() string {
	if o == nil || common.IsNil(o.DateOfInitiationOfLegalProceeding) {
		var ret string
		return ret
	}
	return *o.DateOfInitiationOfLegalProceeding
}

// GetDateOfInitiationOfLegalProceedingOk returns a tuple with the DateOfInitiationOfLegalProceeding field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetDateOfInitiationOfLegalProceedingOk() (*string, bool) {
	if o == nil || common.IsNil(o.DateOfInitiationOfLegalProceeding) {
		return nil, false
	}
	return o.DateOfInitiationOfLegalProceeding, true
}

// HasDateOfInitiationOfLegalProceeding returns a boolean if a field has been set.
func (o *Organization) HasDateOfInitiationOfLegalProceeding() bool {
	if o != nil && !common.IsNil(o.DateOfInitiationOfLegalProceeding) {
		return true
	}
...
// SetDateOfInitiationOfLegalProceeding gets a reference to the given string and assigns it to the DateOfInitiationOfLegalProceeding field.
func (o *Organization) SetDateOfInitiationOfLegalProceeding(v string) {
	o.DateOfInitiationOfLegalProceeding = &v
}
...
// GetDoingBusinessAsAbsent returns the DoingBusinessAsAbsent field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Organization) GetDoingBusinessAsAbsent() bool {
	if o == nil || common.IsNil(o.DoingBusinessAsAbsent.Get()) {
		var ret bool
		return ret
	}
	return *o.DoingBusinessAsAbsent.Get()
}

// GetDoingBusinessAsAbsentOk returns a tuple with the DoingBusinessAsAbsent field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Organization) GetDoingBusinessAsAbsentOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return o.DoingBusinessAsAbsent.Get(), o.DoingBusinessAsAbsent.IsSet()
}

// HasDoingBusinessAsAbsent returns a boolean if a field has been set.
func (o *Organization) HasDoingBusinessAsAbsent() bool {
	if o != nil && o.DoingBusinessAsAbsent.IsSet() {
		return true
	}
...
// SetDoingBusinessAsAbsent gets a reference to the given NullableBool and assigns it to the DoingBusinessAsAbsent field.
...
// UnsetDoingBusinessAsAbsent ensures that no value is present for DoingBusinessAsAbsent, not even an explicit nil
func (o *Organization) UnsetDoingBusinessAsAbsent() {
	o.DoingBusinessAsAbsent.Unset()
}

// GetEconomicSector returns the EconomicSector field value if set, zero value otherwise.
func (o *Organization) GetEconomicSector() string {
	if o == nil || common.IsNil(o.EconomicSector) {
		var ret string
		return ret
	}
	return *o.EconomicSector
}

// GetEconomicSectorOk returns a tuple with the EconomicSector field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetEconomicSectorOk() (*string, bool) {
	if o == nil || common.IsNil(o.EconomicSector) {
		return nil, false
	}
	return o.EconomicSector, true
}

// HasEconomicSector returns a boolean if a field has been set.
func (o *Organization) HasEconomicSector() bool {
	if o != nil && !common.IsNil(o.EconomicSector) {
		return true
	}
...
// SetEconomicSector gets a reference to the given string and assigns it to the EconomicSector field.
func (o *Organization) SetEconomicSector(v string) {
	o.EconomicSector = &v
}
...
// GetGlobalLegalEntityIdentifier returns the GlobalLegalEntityIdentifier field value if set, zero value otherwise.
func (o *Organization) GetGlobalLegalEntityIdentifier() string {
	if o == nil || common.IsNil(o.GlobalLegalEntityIdentifier) {
		var ret string
		return ret
	}
	return *o.GlobalLegalEntityIdentifier
}

// GetGlobalLegalEntityIdentifierOk returns a tuple with the GlobalLegalEntityIdentifier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetGlobalLegalEntityIdentifierOk() (*string, bool) {
	if o == nil || common.IsNil(o.GlobalLegalEntityIdentifier) {
		return nil, false
	}
	return o.GlobalLegalEntityIdentifier, true
}

// HasGlobalLegalEntityIdentifier returns a boolean if a field has been set.
func (o *Organization) HasGlobalLegalEntityIdentifier() bool {
	if o != nil && !common.IsNil(o.GlobalLegalEntityIdentifier) {
		return true
	}
...
// SetGlobalLegalEntityIdentifier gets a reference to the given string and assigns it to the GlobalLegalEntityIdentifier field.
func (o *Organization) SetGlobalLegalEntityIdentifier(v string) {
	o.GlobalLegalEntityIdentifier = &v
}

// GetHeadOfficeIndicator returns the HeadOfficeIndicator field value if set, zero value otherwise.
func (o *Organization) GetHeadOfficeIndicator() bool {
	if o == nil || common.IsNil(o.HeadOfficeIndicator) {
		var ret bool
		return ret
	}
	return *o.HeadOfficeIndicator
}

// GetHeadOfficeIndicatorOk returns a tuple with the HeadOfficeIndicator field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetHeadOfficeIndicatorOk() (*bool, bool) {
	if o == nil || common.IsNil(o.HeadOfficeIndicator) {
		return nil, false
	}
	return o.HeadOfficeIndicator, true
}

// HasHeadOfficeIndicator returns a boolean if a field has been set.
func (o *Organization) HasHeadOfficeIndicator() bool {
	if o != nil && !common.IsNil(o.HeadOfficeIndicator) {
		return true
	}
...
// SetHeadOfficeIndicator gets a reference to the given bool and assigns it to the HeadOfficeIndicator field.
func (o *Organization) SetHeadOfficeIndicator(v bool) {
	o.HeadOfficeIndicator = &v
}

// GetInstitutionalSector returns the InstitutionalSector field value if set, zero value otherwise.
func (o *Organization) GetInstitutionalSector() string {
	if o == nil || common.IsNil(o.InstitutionalSector) {
		var ret string
		return ret
	}
	return *o.InstitutionalSector
}

// GetInstitutionalSectorOk returns a tuple with the InstitutionalSector field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetInstitutionalSectorOk() (*string, bool) {
	if o == nil || common.IsNil(o.InstitutionalSector) {
		return nil, false
	}
	return o.InstitutionalSector, true
}

// HasInstitutionalSector returns a boolean if a field has been set.
func (o *Organization) HasInstitutionalSector() bool {
	if o != nil && !common.IsNil(o.InstitutionalSector) {
		return true
	}
...
// SetInstitutionalSector gets a reference to the given string and assigns it to the InstitutionalSector field.
func (o *Organization) SetInstitutionalSector(v string) {
	o.InstitutionalSector = &v
}

// GetLegalForm returns the LegalForm field value if set, zero value otherwise.
func (o *Organization) GetLegalForm() string {
	if o == nil || common.IsNil(o.LegalForm) {
		var ret string
		return ret
	}
	return *o.LegalForm
...
// and a boolean to check if the value has been set.
func (o *Organization) GetLegalFormOk() (*string, bool) {
	if o == nil || common.IsNil(o.LegalForm) {
		return nil, false
	}
...
func (o *Organization) HasLegalForm() bool {
	if o != nil && !common.IsNil(o.LegalForm) {
		return true
	}
...
// SetLegalForm gets a reference to the given string and assigns it to the LegalForm field.
func (o *Organization) SetLegalForm(v string) {
	o.LegalForm = &v
}
...
// GetRegistrationNumberAbsent returns the RegistrationNumberAbsent field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Organization) GetRegistrationNumberAbsent() bool {
	if o == nil || common.IsNil(o.RegistrationNumberAbsent.Get()) {
		var ret bool
		return ret
	}
	return *o.RegistrationNumberAbsent.Get()
}

// GetRegistrationNumberAbsentOk returns a tuple with the RegistrationNumberAbsent field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Organization) GetRegistrationNumberAbsentOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return o.RegistrationNumberAbsent.Get(), o.RegistrationNumberAbsent.IsSet()
}

// HasRegistrationNumberAbsent returns a boolean if a field has been set.
func (o *Organization) HasRegistrationNumberAbsent() bool {
	if o != nil && o.RegistrationNumberAbsent.IsSet() {
		return true
	}
...
// SetRegistrationNumberAbsent gets a reference to the given NullableBool and assigns it to the RegistrationNumberAbsent field.
...
// UnsetRegistrationNumberAbsent ensures that no value is present for RegistrationNumberAbsent, not even an explicit nil
func (o *Organization) UnsetRegistrationNumberAbsent() {
	o.RegistrationNumberAbsent.Unset()
}

// GetStatusOfLegalProceeding returns the StatusOfLegalProceeding field value if set, zero value otherwise.
func (o *Organization) GetStatusOfLegalProceeding() string {
	if o == nil || common.IsNil(o.StatusOfLegalProceeding) {
		var ret string
		return ret
	}
	return *o.StatusOfLegalProceeding
}

// GetStatusOfLegalProceedingOk returns a tuple with the StatusOfLegalProceeding field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetStatusOfLegalProceedingOk() (*string, bool) {
	if o == nil || common.IsNil(o.StatusOfLegalProceeding) {
		return nil, false
	}
	return o.StatusOfLegalProceeding, true
}

// HasStatusOfLegalProceeding returns a boolean if a field has been set.
func (o *Organization) HasStatusOfLegalProceeding() bool {
	if o != nil && !common.IsNil(o.StatusOfLegalProceeding) {
		return true
	}
...
// SetStatusOfLegalProceeding gets a reference to the given string and assigns it to the StatusOfLegalProceeding field.
func (o *Organization) SetStatusOfLegalProceeding(v string) {
	o.StatusOfLegalProceeding = &v
}
...
func (o *Organization) GetSupport() Support {
	if o == nil || common.IsNil(o.Support) {
		var ret Support
		return ret
	}
	return *o.Support
...
// and a boolean to check if the value has been set.
func (o *Organization) GetSupportOk() (*Support, bool) {
	if o == nil || common.IsNil(o.Support) {
		return nil, false
	}
...
func (o *Organization) HasSupport() bool {
	if o != nil && !common.IsNil(o.Support) {
		return true
	}
...
func (o *Organization) SetSupport(v Support) {
	o.Support = &v
}
...
func (o Organization) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.DateOfInitiationOfLegalProceeding) {
		toSerialize["dateOfInitiationOfLegalProceeding"] = o.DateOfInitiationOfLegalProceeding
	}
	...
	if o.DoingBusinessAsAbsent.IsSet() {
		toSerialize["doingBusinessAsAbsent"] = o.DoingBusinessAsAbsent.Get()
	}
	if !common.IsNil(o.EconomicSector) {
		toSerialize["economicSector"] = o.EconomicSector
	}
	...
	if !common.IsNil(o.GlobalLegalEntityIdentifier) {
		toSerialize["globalLegalEntityIdentifier"] = o.GlobalLegalEntityIdentifier
	}
	if !common.IsNil(o.HeadOfficeIndicator) {
		toSerialize["headOfficeIndicator"] = o.HeadOfficeIndicator
	}
	if !common.IsNil(o.InstitutionalSector) {
		toSerialize["institutionalSector"] = o.InstitutionalSector
	}
	if !common.IsNil(o.LegalForm) {
	...
	if o.RegistrationNumberAbsent.IsSet() {
		toSerialize["registrationNumberAbsent"] = o.RegistrationNumberAbsent.Get()
	}
	if !common.IsNil(o.StatusOfLegalProceeding) {
		toSerialize["statusOfLegalProceeding"] = o.StatusOfLegalProceeding
	}
	if !common.IsNil(o.StockData) {
		toSerialize["stockData"] = o.StockData
	}
	if !common.IsNil(o.Support) {

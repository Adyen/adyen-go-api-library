...
func (o *Individual) GetSupport() Support {
...
// and a boolean to check if the value has been set.
func (o *Individual) GetSupportOk() (*Support, bool) {
	if o == nil || common.IsNil(o.Support) {
		return nil, false
	}
...
func (o *Individual) HasSupport() bool {
	if o != nil && !common.IsNil(o.Support) {
		return true
	}
...
func (o *Individual) SetSupport(v Support) {
	o.Support = &v
}

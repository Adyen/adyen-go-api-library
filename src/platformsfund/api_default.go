...
/*
AccountHolderBalancePost Retrieve the balance(s) of an account holder.
...
/*
AccountHolderTransactionListPost Retrieve a list of transactions.
...
/*
PayoutAccountHolderPost Disburse a specified amount from an account to the account holder.
...
/*
RefundFundsTransferPost Make a refund of the existing transfer funds transfer.
...
/*
RefundNotPaidOutTransfersPost Refund all transactions of an account since the most recent payout.
...
/*
SetupBeneficiaryPost Designate an account to be the beneficiary of a separate account and transfer the benefactor's current balance to the beneficiary.
...
/*
TransferFundsPost Transfer funds from one platform account to another.

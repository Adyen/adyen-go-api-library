...
func (o *AdditionalBankIdentification) GetType() AdditionalBankIdentificationTypes {
	if o == nil || common.IsNil(o.Type) {
		var ret AdditionalBankIdentificationTypes
		return ret
	}
	return *o.Type
}
...
// and a boolean to check if the value has been set.
func (o *AdditionalBankIdentification) GetTypeOk() (*AdditionalBankIdentificationTypes, bool) {
	if o == nil || common.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
// SetType gets a reference to the given AdditionalBankIdentificationTypes and assigns it to the Type field.
func (o *AdditionalBankIdentification) SetType(v AdditionalBankIdentificationTypes) {
	o.Type = &v
}

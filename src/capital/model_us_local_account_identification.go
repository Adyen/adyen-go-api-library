...
func (o *USLocalAccountIdentification) GetAccountType() USLocalBankAccountType {
...
// and a boolean to check if the value has been set.
func (o *USLocalAccountIdentification) GetAccountTypeOk() (*USLocalBankAccountType, bool) {
	if o == nil || common.IsNil(o.AccountType) {
		return nil, false
	}
...
func (o *USLocalAccountIdentification) SetAccountType(v USLocalBankAccountType) {
	o.AccountType = &v
}

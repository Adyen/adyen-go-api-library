...
func (o *GrantInfo) GetAmount() Amount {
...
func (o *GrantInfo) GetAmountOk() (*Amount, bool) {
	if o == nil || common.IsNil(o.Amount) {
		return nil, false
	}
...
func (o *GrantInfo) HasAmount() bool {
	if o != nil && !common.IsNil(o.Amount) {
		return true
	}
...
func (o *GrantInfo) SetAmount(v Amount) {
	o.Amount = &v
}

// GetCounterparty returns the Counterparty field value if set, zero value otherwise.
func (o *GrantInfo) GetCounterparty() Counterparty {
...
// and a boolean to check if the value has been set.
func (o *GrantInfo) GetCounterpartyOk() (*Counterparty, bool) {
	if o == nil || common.IsNil(o.Counterparty) {
		return nil, false
	}
...
func (o *GrantInfo) SetCounterparty(v Counterparty) {
	o.Counterparty = &v
}

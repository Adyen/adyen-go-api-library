...
func (o *Grant) GetAmountOk() (*Amount, bool) {
	if o == nil || common.IsNil(o.Amount) {
		return nil, false
	}
...
func (o *Grant) SetAmount(v Amount) {
	o.Amount = &v
}
...
func (o *Grant) GetCounterparty() Counterparty {
...
// and a boolean to check if the value has been set.
func (o *Grant) GetCounterpartyOk() (*Counterparty, bool) {
	if o == nil || common.IsNil(o.Counterparty) {
		return nil, false
	}
...
func (o *Grant) SetCounterparty(v Counterparty) {
	o.Counterparty = &v
}

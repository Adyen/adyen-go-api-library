...
func (o *CALocalAccountIdentification) GetAccountType() CALocalBankAccountType {
...
// and a boolean to check if the value has been set.
func (o *CALocalAccountIdentification) GetAccountTypeOk() (*CALocalBankAccountType, bool) {
	if o == nil || common.IsNil(o.AccountType) {
		return nil, false
	}
...
func (o *CALocalAccountIdentification) SetAccountType(v CALocalBankAccountType) {
	o.AccountType = &v
}

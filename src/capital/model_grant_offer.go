...
func (o *GrantOffer) GetFee() GrantOfferFee {
...
// and a boolean to check if the value has been set.
func (o *GrantOffer) GetFeeOk() (*GrantOfferFee, bool) {
	if o == nil || common.IsNil(o.Fee) {
		return nil, false
	}
	return o.Fee, true
...
// SetFee gets a reference to the given GrantOfferFee and assigns it to the Fee field.
func (o *GrantOffer) SetFee(v GrantOfferFee) {
	o.Fee = &v
}

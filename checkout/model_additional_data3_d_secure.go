...
var _ MappedNullable = &AdditionalData3DSecure{}
...
func (o *AdditionalData3DSecure) GetChallengeWindowSize() string {
	if o == nil || IsNil(o.ChallengeWindowSize) {
		var ret string
		return ret
	}
...
func (o *AdditionalData3DSecure) GetExecuteThreeD() string {
	if o == nil || IsNil(o.ExecuteThreeD) {
		var ret string
		return ret
	}
...
func (o *AdditionalData3DSecure) GetMpiImplementationType() string {
	if o == nil || IsNil(o.MpiImplementationType) {
		var ret string
		return ret
	}

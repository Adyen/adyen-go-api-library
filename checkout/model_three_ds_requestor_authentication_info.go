...
var _ MappedNullable = &ThreeDSRequestorAuthenticationInfo{}
...
func (o *ThreeDSRequestorAuthenticationInfo) GetThreeDSReqAuthData() string {
	if o == nil || IsNil(o.ThreeDSReqAuthData) {
		var ret string
		return ret
	}
...
func (o *ThreeDSRequestorAuthenticationInfo) GetThreeDSReqAuthMethod() string {
	if o == nil || IsNil(o.ThreeDSReqAuthMethod) {
		var ret string
		return ret
	}
...
func (o *ThreeDSRequestorAuthenticationInfo) GetThreeDSReqAuthTimestamp() string {
	if o == nil || IsNil(o.ThreeDSReqAuthTimestamp) {
		var ret string
		return ret
	}

...
func (o *CardDetails) GetEncryptedExpiryMonth() string {
	if o == nil || IsNil(o.EncryptedExpiryMonth) {
		var ret string
		return ret
	}
...
func (o *CardDetails) GetEncryptedExpiryYear() string {
	if o == nil || IsNil(o.EncryptedExpiryYear) {
		var ret string
		return ret
	}
...
func (o *CardDetails) GetEncryptedSecurityCode() string {
	if o == nil || IsNil(o.EncryptedSecurityCode) {
		var ret string
		return ret
	}
...
func (o *CardDetails) GetNetworkPaymentReference() string {
	if o == nil || IsNil(o.NetworkPaymentReference) {
		var ret string
		return ret
	}
...
func (o *CardDetails) GetShopperNotificationReference() string {
	if o == nil || IsNil(o.ShopperNotificationReference) {
		var ret string
		return ret
	}
...
func (o *CardDetails) GetThreeDS2SdkVersion() string {
	if o == nil || IsNil(o.ThreeDS2SdkVersion) {
		var ret string
		return ret
	}
...
func (o CardDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NetworkPaymentReference) {

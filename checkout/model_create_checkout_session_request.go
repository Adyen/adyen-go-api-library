...
func (o *CreateCheckoutSessionRequest) GetBlockedPaymentMethods() []string {
	if o == nil || IsNil(o.BlockedPaymentMethods) {
		var ret []string
		return ret
	}
...
func (o *CreateCheckoutSessionRequest) GetEnableOneClick() bool {
	if o == nil || IsNil(o.EnableOneClick) {
		var ret bool
		return ret
	}
...
func (o *CreateCheckoutSessionRequest) GetEnableRecurring() bool {
	if o == nil || IsNil(o.EnableRecurring) {
		var ret bool
		return ret
	}
...
func (o *CreateCheckoutSessionRequest) GetFundRecipient() FundRecipient {
	if o == nil || IsNil(o.FundRecipient) {
...
func (o *CreateCheckoutSessionRequest) GetInstallmentOptions() map[string]CheckoutSessionInstallmentOption {
	if o == nil || IsNil(o.InstallmentOptions) {
...
func (o *CreateCheckoutSessionRequest) GetRedirectFromIssuerMethod() string {
	if o == nil || IsNil(o.RedirectFromIssuerMethod) {
		var ret string
		return ret
	}
...
func (o *CreateCheckoutSessionRequest) GetRedirectToIssuerMethod() string {
	if o == nil || IsNil(o.RedirectToIssuerMethod) {
		var ret string
		return ret
	}
...
func (o *CreateCheckoutSessionRequest) GetSplitCardFundingSources() bool {
	if o == nil || IsNil(o.SplitCardFundingSources) {
		var ret bool
		return ret
	}
...
func (o *CreateCheckoutSessionRequest) GetStorePaymentMethod() bool {
	if o == nil || IsNil(o.StorePaymentMethod) {
		var ret bool
		return ret
	}
...
func (o *CreateCheckoutSessionRequest) GetStorePaymentMethodMode() string {
	if o == nil || IsNil(o.StorePaymentMethodMode) {
		var ret string
		return ret
	}
...
func (o CreateCheckoutSessionRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BlockedPaymentMethods) {
	...
	if !IsNil(o.RedirectFromIssuerMethod) {
		toSerialize["redirectFromIssuerMethod"] = o.RedirectFromIssuerMethod
	}
	if !IsNil(o.RedirectToIssuerMethod) {
	...
	if !IsNil(o.SplitCardFundingSources) {
	...
	if !IsNil(o.StorePaymentMethod) {
		toSerialize["storePaymentMethod"] = o.StorePaymentMethod
	}
	if !IsNil(o.StorePaymentMethodMode) {

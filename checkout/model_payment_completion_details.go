...
var _ MappedNullable = &PaymentCompletionDetails{}
...
func (o *PaymentCompletionDetails) GetCupsecureplusSmscode() string {
	if o == nil || IsNil(o.CupsecureplusSmscode) {
		var ret string
		return ret
	}
...
func (o *PaymentCompletionDetails) GetFacilitatorAccessToken() string {
	if o == nil || IsNil(o.FacilitatorAccessToken) {
		var ret string
		return ret
	}
...
func (o *PaymentCompletionDetails) GetRedirectResult() string {
	if o == nil || IsNil(o.RedirectResult) {
		var ret string
		return ret
	}
...
func (o *PaymentCompletionDetails) GetThreeDSResult() string {
	if o == nil || IsNil(o.ThreeDSResult) {
		var ret string
		return ret
	}
...
func (o *PaymentCompletionDetails) GetThreeds2ChallengeResult() string {
	if o == nil || IsNil(o.Threeds2ChallengeResult) {
		var ret string
		return ret
	}
...
func (o *PaymentCompletionDetails) GetThreeds2Fingerprint() string {
	if o == nil || IsNil(o.Threeds2Fingerprint) {
		var ret string
		return ret
	}

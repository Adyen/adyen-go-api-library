...
var _ MappedNullable = &ThreeDS2ResponseData{}
...
func (o *ThreeDS2ResponseData) GetAcsOperatorID() string {
	if o == nil || IsNil(o.AcsOperatorID) {
		var ret string
		return ret
	}
...
func (o *ThreeDS2ResponseData) GetExemptionIndicator() string {
	if o == nil || IsNil(o.ExemptionIndicator) {
		var ret string
		return ret
	}
...
func (o *ThreeDS2ResponseData) GetThreeDSServerTransID() string {
	if o == nil || IsNil(o.ThreeDSServerTransID) {
		var ret string
		return ret
	}
...
func (o *ThreeDS2ResponseData) GetTransStatusReason() string {
	if o == nil || IsNil(o.TransStatusReason) {
		var ret string
		return ret
	}

...
var _ MappedNullable = &ResponseAdditionalDataNetworkTokens{}
...
func (o *ResponseAdditionalDataNetworkTokens) GetNetworkTokenAvailable() string {
	if o == nil || IsNil(o.NetworkTokenAvailable) {
		var ret string
		return ret
	}
...
func (o *ResponseAdditionalDataNetworkTokens) GetNetworkTokenBin() string {
	if o == nil || IsNil(o.NetworkTokenBin) {
		var ret string
		return ret
	}
...
func (o *ResponseAdditionalDataNetworkTokens) GetNetworkTokenTokenSummary() string {
	if o == nil || IsNil(o.NetworkTokenTokenSummary) {
		var ret string
		return ret
	}

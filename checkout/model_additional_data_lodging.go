...
var _ MappedNullable = &AdditionalDataLodging{}
...
func (o *AdditionalDataLodging) GetLodgingCheckInDate() string {
	if o == nil || IsNil(o.LodgingCheckInDate) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingCheckOutDate() string {
	if o == nil || IsNil(o.LodgingCheckOutDate) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingCustomerServiceTollFreeNumber() string {
	if o == nil || IsNil(o.LodgingCustomerServiceTollFreeNumber) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingFireSafetyActIndicator() string {
	if o == nil || IsNil(o.LodgingFireSafetyActIndicator) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingFolioCashAdvances() string {
	if o == nil || IsNil(o.LodgingFolioCashAdvances) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingFolioNumber() string {
	if o == nil || IsNil(o.LodgingFolioNumber) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingFoodBeverageCharges() string {
	if o == nil || IsNil(o.LodgingFoodBeverageCharges) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingNoShowIndicator() string {
	if o == nil || IsNil(o.LodgingNoShowIndicator) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingPrepaidExpenses() string {
	if o == nil || IsNil(o.LodgingPrepaidExpenses) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingPropertyPhoneNumber() string {
	if o == nil || IsNil(o.LodgingPropertyPhoneNumber) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingRoom1NumberOfNights() string {
	if o == nil || IsNil(o.LodgingRoom1NumberOfNights) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingRoom1Rate() string {
	if o == nil || IsNil(o.LodgingRoom1Rate) {
		var ret string
		return ret
	}
...
// GetLodgingRoom1Tax returns the LodgingRoom1Tax field value if set, zero value otherwise.
func (o *AdditionalDataLodging) GetLodgingRoom1Tax() string {
	if o == nil || IsNil(o.LodgingRoom1Tax) {
		var ret string
		return ret
	}
	return *o.LodgingRoom1Tax
}

// GetLodgingRoom1TaxOk returns a tuple with the LodgingRoom1Tax field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AdditionalDataLodging) GetLodgingRoom1TaxOk() (*string, bool) {
	if o == nil || IsNil(o.LodgingRoom1Tax) {
		return nil, false
	}
	return o.LodgingRoom1Tax, true
}
...
// SetLodgingRoom1Tax gets a reference to the given string and assigns it to the LodgingRoom1Tax field.
...
func (o *AdditionalDataLodging) GetLodgingTotalRoomTax() string {
	if o == nil || IsNil(o.LodgingTotalRoomTax) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataLodging) GetLodgingTotalTax() string {
	if o == nil || IsNil(o.LodgingTotalTax) {
		var ret string
		return ret
	}

...
var _ MappedNullable = &AdditionalDataRiskStandalone{}
...
func (o *AdditionalDataRiskStandalone) GetPayPalCountryCode() string {
	if o == nil || IsNil(o.PayPalCountryCode) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataRiskStandalone) GetPayPalEmailId() string {
	if o == nil || IsNil(o.PayPalEmailId) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataRiskStandalone) GetPayPalFirstName() string {
	if o == nil || IsNil(o.PayPalFirstName) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataRiskStandalone) GetPayPalLastName() string {
	if o == nil || IsNil(o.PayPalLastName) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataRiskStandalone) GetPayPalProtectionEligibility() string {
	if o == nil || IsNil(o.PayPalProtectionEligibility) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataRiskStandalone) GetPayPalTransactionId() string {
	if o == nil || IsNil(o.PayPalTransactionId) {
		var ret string
		return ret
	}
...
func (o *AdditionalDataRiskStandalone) GetTokenDataType() string {
	if o == nil || IsNil(o.TokenDataType) {
		var ret string
		return ret
	}

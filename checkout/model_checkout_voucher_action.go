...
var _ MappedNullable = &CheckoutVoucherAction{}
...
func (o *CheckoutVoucherAction) GetAlternativeReference() string {
	if o == nil || IsNil(o.AlternativeReference) {
		var ret string
		return ret
	}
...
func (o *CheckoutVoucherAction) GetCollectionInstitutionNumber() string {
	if o == nil || IsNil(o.CollectionInstitutionNumber) {
		var ret string
		return ret
	}
...
func (o *CheckoutVoucherAction) GetInstructionsUrl() string {
	if o == nil || IsNil(o.InstructionsUrl) {
		var ret string
		return ret
	}
...
func (o *CheckoutVoucherAction) GetMaskedTelephoneNumber() string {
	if o == nil || IsNil(o.MaskedTelephoneNumber) {
		var ret string
		return ret
	}
...
func (o CheckoutVoucherAction) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AlternativeReference) {
		toSerialize["alternativeReference"] = o.AlternativeReference
	}
	if !IsNil(o.CollectionInstitutionNumber) {
	...
	if !IsNil(o.InstructionsUrl) {
		toSerialize["instructionsUrl"] = o.InstructionsUrl
	}
	if !IsNil(o.Issuer) {
		toSerialize["issuer"] = o.Issuer
	}
	if !IsNil(o.MaskedTelephoneNumber) {
